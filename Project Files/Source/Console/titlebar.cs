...
namespace Thetis
{
    class TitleBar
    {
        public const string BUILD_NAME = "HL2-Beta1";
        public const string BUILD_DATE = "(10/31/22)<FW>"; //MW0LGE_21g <FW> gets replaced in BasicTitle (console.cs) with firmware version
